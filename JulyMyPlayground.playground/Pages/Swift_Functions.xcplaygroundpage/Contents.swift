...
/// `() -> ()`
/// `(Int, Int) -> Void'
/// **Function Signature** is the function  the parameters type without the name and return type of the function
...
///This means that the caller can omit the parameter entirelysupplying no argument for it
...
//TODO: NOTE
///In Swift 5.3 and before, a function can declare a maximum of one variadic parameter.
///Starting in Swift 5.4, that restriction has been lifted.
///Even two variadic parameters in a row are now legal, though you still need an external label on the second one as below:
